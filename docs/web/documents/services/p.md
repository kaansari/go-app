...
<div class="container">
    <div class="text-container">
        ...
        <h1 style="text-align: center; color: white;">P-SHOT Services Offered In Downtown Chicago, IL</h1>
        <p style="text-align: center; color: white;">P-Shot®, a revolutionary medical procedure, utilizes platelet-rich plasma (PRP) to enhance sexual performance and treat erectile dysfunction, providing a safe and effective solution for men seeking to improve their intimate health.</p>
    </div>
    <div class="image-container">
        <img src="/web/images/p.png" alt="NAD+ Image" style="width: 100%; height: 100%; object-fit: contain; border-radius: 0;">
    </div>
</div>
